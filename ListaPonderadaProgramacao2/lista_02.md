...
INICIO
    ...
    SE valorCompra < 50.00 ENTAO
        ESCREVA "Frete não disponível!"
    SENAO SE valorCompra <= 199.99 ENTAO
...
Classe Carro HERDA Veiculo:
    ...
    Método CalcularConsumo(distancia):
        SE eficiencia > 0 ENTAO
            ...
            Retornar consumo
        SENAO
            Retornar "Erro: Eficiência deve ser maior que zero."
...
INICIO
    ...
    ESCREVA "Digite a velocidade segura de pouso (m/s): "
    ...
    SE velocidadeAtual > velocidadeSegura ENTAO
        ESCREVA "A sonda não conseguiu reduzir a velocidade a tempo! Abortando pouso."
    FIMSE
FIM
```
...
Função MultiplicarMatrizesInvestimento(matrizA, matrizB):  
    ...
    # Loop para percorrer e calcular a multiplicação  
